...
SRC_C += \
	...
	$(TOP)/tinyusb/src/class/audio/audio_device.c \
	$(TOP)/tinyusb/src/class/cdc/cdc_device.c \
	$(TOP)/tinyusb/src/class/dfu/dfu_rt_device.c \
	$(TOP)/tinyusb/src/class/hid/hid_device.c \
	$(TOP)/tinyusb/src/class/midi/midi_device.c \
	$(TOP)/tinyusb/src/class/msc/msc_device.c \
	$(TOP)/tinyusb/src/class/net/net_device.c \
	$(TOP)/tinyusb/src/class/usbtmc/usbtmc_device.c \
	$(TOP)/tinyusb/src/class/vendor/vendor_device.c \
	$(TOP)/tinyusb/src/portable/$(VENDOR)/$(CHIP_FAMILY)/dcd_$(CHIP_FAMILY).c
